#!/usr/bin/env bash
# =============================================================================
# modules/10-n8n.sh — n8n + PostgreSQL (VPN-only via Traefik)
# =============================================================================
# Optional module.
#
# Deploys:
...
# n8n secrets (generated by init-env.sh unless set)
N8N_DB_PASSWORD="${N8N_DB_PASSWORD:-__N8N_DB_PASSWORD__}"
N8N_ENCRYPTION_KEY="${N8N_ENCRYPTION_KEY:-__N8N_ENCRYPTION_KEY__}"
N8N_BASIC_AUTH_USER="${N8N_BASIC_AUTH_USER:-admin}"
N8N_BASIC_AUTH_PASSWORD="${N8N_BASIC_AUTH_PASSWORD:-__N8N_BASIC_AUTH_PASSWORD__}"
...
install_env_file() {
  ...
  if [[ "$N8N_BASIC_AUTH_PASSWORD" == "__N8N_BASIC_AUTH_PASSWORD__" ]]; then
    log_warn "N8N_BASIC_AUTH_PASSWORD not set — using placeholder"
  fi
...
patch_traefik_routes() {
  ...
  if [[ ! -f "$TRAEFIK_DYNAMIC" ]]; then
    log_fatal "Traefik dynamic config not found at ${TRAEFIK_DYNAMIC}. Run module 06-traefik first."
  fi
